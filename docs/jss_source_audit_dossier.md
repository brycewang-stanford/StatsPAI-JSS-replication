...
econometrics. The live registry reports 1,220 registered public functions
...
Current JSS source-snapshot audit counts: 414 `certified`, 142 `validated`, 661 `api_stable`, and 3 `experimental` registry symbols. The certified/validated
...
The current source snapshot also tracks 490 registry-evidence source files
