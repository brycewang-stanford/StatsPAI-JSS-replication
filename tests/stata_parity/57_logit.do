...
clear all
do _common.do
stata_parity_init, module(57_logit)
stata_parity_open, module(57_logit)

import delimited "${STATA_PARITY_DATA}/57_logit.csv", clear case(preserve)
local n = _N
...
stata_parity_extra, key(stata_command) val("logit y x1 x2")

stata_parity_close, module(57_logit)
